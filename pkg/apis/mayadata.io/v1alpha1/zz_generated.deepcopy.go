...
func (in *DMaaSBackupSpec) DeepCopyInto(out *DMaaSBackupSpec) {
	*out = *in
	if in.PreBackupActionName != nil {
		in, out := &in.PreBackupActionName, &out.PreBackupActionName
		*out = new(string)
		**out = **in
	}
...
func (in *DMaaSBackupStatus) DeepCopyInto(out *DMaaSBackupStatus) {
	*out = *in
	...
	if in.LatestBackupStatus != nil {
		in, out := &in.LatestBackupStatus, &out.LatestBackupStatus
