...
// PreBackupActions returns a PreBackupActionInformer.
func (v *version) PreBackupActions() PreBackupActionInformer {
	return &preBackupActionInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
