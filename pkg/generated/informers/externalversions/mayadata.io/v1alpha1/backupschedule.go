	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MayadataV1alpha1().BackupSchedules(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MayadataV1alpha1().BackupSchedules(namespace).Watch(options)
			},
		},
		&mayadataiov1alpha1.BackupSchedule{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *backupScheduleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mayadataiov1alpha1.BackupSchedule{}, f.defaultInformer)
}
